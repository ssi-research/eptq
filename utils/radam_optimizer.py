...
class RAdam(OptimizerV2):
    ...
    def _create_slots(self, var_list: List[tf.Variable]):
        """
        Allocate additional variables associated with the trainable parameters.
    ...
    def set_weights(self,
        ...
        """
        Set the weights of the optimizer (its state).
    ...
    def _resource_apply_dense(self,
        ...
        """
        Add operation to apply a gradient to a variable.

        Args:
            grad: Gradient to apply.
            var: Variable to apply the gradient to.
    ...
    def _resource_apply_sparse(self,
        ...
        """
         ...
         Args:
             grad: Gradient to apply.
             var: Variable to apply the gradient to.
             indices: Indices of nonzero gradients.
